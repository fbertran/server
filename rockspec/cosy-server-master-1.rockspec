...
build = {
  ...
  modules = {
    ...
    ["cosy.server.users.projects"    ] = "src/cosy/server/users/projects.lua",
    ...
    ["cosy.server.resources"         ] = "src/cosy/server/resources/init.lua",
    ["cosy.server.resources.resource"] = "src/cosy/server/resources/resource.lua",
